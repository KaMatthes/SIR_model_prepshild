...
df1 <- data.frame(time= 35,
                  prop = c(0.5,0.007, 0.0010), 
...
ggplot(dt, aes(x = time)) +
  ...
  labs(title = "Dengue - Mild Scenario - 80 days",
       x = "Days",
       y = "Individuals")+
  scale_color_manual("",
...
ggsave("figures/dengue/mild_age_meas80.png",h=8,w=20)
...
ggsave("figures/dengue/severe_age_meas80.png",h=8,w=20)
