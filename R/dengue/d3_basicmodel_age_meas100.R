...
ggplot(dt, aes(x = time)) +
  ...
  labs(title = "Dengue - Mild Scenario - 100 days",
       x = "Days",
       y = "Individuals")+
  scale_color_manual("",
...
ggsave("figures/dengue/mild_age_meas100.png",h=8,w=20)
...
ggsave("figures/dengue/severe_age_meas100.png",h=8,w=20)
